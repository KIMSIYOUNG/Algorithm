...
class Solution {
        public int[] solution(int[] answers) {
            //TODO 수포자의 찍기 패턴 수 st1 = 5, st2 = 8, st3 = 10
            int [] st1 = {1,2,3,4,5};
            int [] st2 = {2,1,2,3,2,4,2,5};
            int [] st3 = {3,3,1,1,2,2,4,4,5,5};
            int [] cnt = new int [3]; //3명의 학생이므로 정답을 체크하기 위한 배열 cnt 생성

            //TODO 정답과 찍은답과 비교하여 동일한 경우 cnt ++
            ...
            //TODO 1번 학생을 winner로 잡고 차례대로 비교하여 가장 높은 점수 확인
            int winner = cnt [0];
            ...
            //TODO cnt 배열과 가장 높은 점수를 비교하여 동일한 경우 win List에 추가
            for (int i=0; i<cnt.length; i++){
                if (winner==cnt[i]){
                    win.add(i);
                }
            ...
            //TODO 출력할 배열 answer에 List에 있는 학생번호 입력
